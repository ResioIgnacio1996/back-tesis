...
class EmpresaRuter {
    ...
    config() {
        ...
        this.router.put('/updateEmpresaXdia/:idE/:idD/:hd/:hh', empresaCotroller_1.default.updateEmpresaXdia);
        ...
        this.router.get('/listEtadoViaje', empresaCotroller_1.default.listEtadoViaje)
