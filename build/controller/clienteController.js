...
class ClineteController {
    ...
    saveViaje(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query("INSERT INTO viaje (origen, destino,  longitud, latitud, estado, idCliente, idEmpresa,  fecha, distancia, idMotivoCancelacion,fecha_modificacion,fecha_hora_solicitado) values('" + origen + "', '" + destino + "'," + longitud + "," + latitud + "," + estado + "," + idCliente + "," + idEmpresa + ", curdate() ," + distancia + "," + 0 + ",now(),now())")
